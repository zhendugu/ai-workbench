 ...
 */
export function guardNoFieldExtensions(entity: unknown, allowedFields: readonly string[]): boolean {
 ...
 */
export function guardNoDynamicVocabulary(text: string): boolean {
 ...
 */
export function guardNoStateMachine(company: Company): boolean {
 ...
 */
export function hasStateMachineFields(data: Record<string, unknown>): boolean {
 ...
 */
export function guardRoleAttachment(role: Role, cellIdentifiers: Set<string>): boolean {
 ...
 */
export function validateAllRolesAttached(roles: Role[], cellIdentifiers: Set<string>): boolean {
 ...
 */
export function guardTopologyTypeEnum(relationshipType: string): boolean {
  const validTypes: string[] = ['dependency', 'reference', 'input_output'];
 ...
 */
export function guardNoTemporalVocabulary(description?: string): boolean {
  if (!description) {
 ...
 */
export function guardFreezeRecordNoEventSemantics(freezeRecord: FreezeRecord): boolean {
 ...
 */
export function guardFreezeTimestampLabel(label: string): boolean {
 ...
 */
export function guardNoInterpretation(uiText: string): boolean {
 ...
 */
export function guardCopyReadOnly(actionLabel: string): boolean {
...
export function runAllGuards(data: {
  ...
  if (data.company) {
    const hasStateFields = hasStateMachineFields(data.company as unknown as Record<string, unknown>);
    results.push({
      guard: 'G-3',
  ...
  if (data.relationships) {
    ...
    results.push({
      ...
      message:
        allValidTypes && !hasTemporalVocab
